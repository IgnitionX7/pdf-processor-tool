...
from .routes import sessions, stage1, stage2, stage3, stage4, figure_extractor, gcs_uploader, url_merger, enhanced_extractor
...
app.include_router(enhanced_extractor.router)
